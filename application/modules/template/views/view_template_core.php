                ...
                <div id="mainnav-menu-wrap">
                    <div class="nano">
                        ...
                        <ul id="mainnav-menu" class="list-group">
                           ...
                           <li class=" <?=$this->uri->segment('1') == 'data_kamar' || $this->uri->segment(1) == 'data_kamar' ? "active-sub" : ''?>">
                            <a href="">
                           ...
                           <ul class="collapse">
                            <li class="<?php if ( $this->uri->segment(1) == 'data_kamar' ) echo 'active-link'; ?>"><a href="<?php echo base_url('data_kamar'); ?>">Data Kamar</a></li>
                            <li class="<?php if ( $this->uri->segment(1) == 'data_fasilitas' ) echo 'active-link'; ?>"><a href="<?php echo base_url('data_fasilitas'); ?>">Fasilitas</a></li>
                            <li class="<?php if ( $this->uri->segment(1) == 'jenis_kamar' ) echo 'active-link'; ?>"><a href="<?php echo base_url('jenis_kamar'); ?>">Jenis Kamar</a></li>
                        </ul>
                    </li>

                    
                    <li class=" <?=$this->uri->segment('1') == 'data_user' || $this->uri->segment(1) == 'data_treatment' || $this->uri->segment(1) == 'data_prestasi' ? "active-sub" : ''?>">
